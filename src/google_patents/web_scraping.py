...
if __name__ == "__main__":
    list_patents = pd.read_csv('patents/Patents - Página1.csv')['publication_number'].tolist() #caminho
    #publication_number = "CN111909735A" 

    for e,i in enumerate(list_patents):
        publication_number = i
        filename = f"patents/{publication_number}.json"
        url = f"https://patents.google.com/patent/{publication_number}/en"

        print(f"{e}. Buscando dados da patente: {publication_number}...")
        ...
        if page_content:
            ...
            print(f"\n✅ {e}. Dados salvos com sucesso em '{filename}'")